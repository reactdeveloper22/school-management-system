...
if(isset($_POST['add_product'])){
   ...
   $select_products = $conn->prepare("SELECT * FROM `student`` WHERE fname = ?");
   ...
   <?php
         ...
         if($show_products->rowCount() > 0){
            while($fetch_products = $show_products->fetch(PDO::FETCH_ASSOC)){
               ...
               echo "<tr><td>". $fetch_products['id'] ."<td/<td>". $fetch_products['fname'] ."<td/<td>". $fetch_products['lname']. "<td/<td>". $fetch_products['age']."<td/<td>". $fetch_products['email']."<td/<td>".$fetch_products['dateOfbirth'] ."<td/<td>". $fetch_products['home'] ."<td/<td>". $fetch_products['mobile'] ."<td/<td>". $fetch_products['gender'] ."<td/<td>". $fetch_products['idNum'] ."<td/<td>". $fetch_products['address'] ."<td/<td>". $fetch_products['postal'] ."<td/<td>". $fetch_products['school'] ."<td/<td>". $fetch_products['diggers'] ."<td/<td>". $fetch_products['nationality'] .
                "<td/<td>" ."<a class= option href=student_update.php?update=".$fetch_products['id']. ">Update</a>".       
                "<a class= delete onclick=return confirm('delete this product?') href=admin_studint.php?delete=".$fetch_products['id']. ">Delete</a>"."</td/<td>";
...
<a href="student.php" class="button">Add New Student</a>
</section>
